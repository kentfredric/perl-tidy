...
We have had some recent reports of problems with versions this old, however,
but we have not heard of any problems with Perl 5.005 and later, though.
...
about 1 Mb.  (If really neccessary, this could be reduced to about 320k by
