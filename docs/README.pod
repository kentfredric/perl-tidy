...
ActiveState to look into it if this is a general problem.

There are no known problems running perltidy under ActiveState Perl and
Windows 95 and Windows 2000.

=head2 Installation - Windows

Here is how to install perltidy under Windows.
...
=head2 Windows 95 problem with command.com

There is a minor problem that you should be aware of if you are running
perltidy (and perl) under Windows 95 with the F<command.com>
