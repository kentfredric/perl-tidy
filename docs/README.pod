...
or later.  (You can find your version with C<perl -v>). It may use these
...
will about 1 Mb.  (If neccessary, this could be reduced to about 320k
by using perltidy to squeeze itself down using B<-dac --mangle> .)
