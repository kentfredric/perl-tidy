...
There are very few.  The main requirement is Perl version 5.004 or
later.  It is known to work under Unix systems, Windows 95 and later,
and VMS.  It should work with MacPerl.  It does not require any
non-standard modules to work, but it may use certain modules if
detected, as follows:
