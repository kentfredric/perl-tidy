...
The default value is system dependent.  On Unix systems, the default is to
do a syntax check; on Windows systems, the default is not to do the check.
...
This man page documents perltidy version 20011003.
