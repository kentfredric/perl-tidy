...
=head2 Gnu/emacs style indentation
...
is selected with the '-gnu' flag, is being tested.  It formats
lists, without side comments, at the present time.  It does not format
sub call lists.
