...
The output will be controlled by a switch B<--format=s>, or simply B<-f=s>,
where B<s> would be B<html>, B<xml>, or B<tidy>.  The current B<-html> flag
would be mapped into B<-format=html>.
