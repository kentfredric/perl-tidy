...
There are a large number of little open formatting issues.  I'm working on
them as time permits.

=head2 Modularization

Modularization work is in progress.  I hope to have modularization patches 
made by Hugh Myers integrated into the next release.
...
One way to do this would be to first implement the XML feature mentioned above,
and then write a utility to read the XML and process it.
