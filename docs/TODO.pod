...
=head2 Improved HTML formatting of pod sections

At present, pod text is merely formatted with italics.  It would be nice
to properly format pod, just like pod2html.  This is a high priority
item.
...
=head2 Eliminate the need for IO::Scalar and IO::ScalarArray

These might become builtin.
