...
working on them as time permits, with priority given to items that are
of interest to perltidy users.
...
be addressed to make the tokenizer more correct, even though
