...
=head2 perl v5.6.0 features not yet parsed correctly (SLH, 2001-03-31)

Subroutine attributes have not been implemented in perltdy yet.  For example:
...
For now, the workaround is to place the prototype on the same line as the sub
name, like this:
