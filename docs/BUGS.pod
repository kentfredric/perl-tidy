...
=head2 A here-doc invoked through an 'e' modifier on the replacement text is not recognized (SLH, 2001-08-02)
...
name.  For example, this would cause an error:
...
The workaround is to place the prototype and/or attribute on the same
