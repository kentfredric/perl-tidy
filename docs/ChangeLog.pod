=head1 Perltidy Change Log
 ...
 -Parameters for controlling 'vertical tightness' have been added:
  ...
  See updated manual. Simple examples:
 ...
 -Removed undocumented parameter --maximum-space-to-comment, which isn't
  necessary and causes some unwanted limitations. Thanks to Wolfgang 
  Weisselberg.
