...
=head2 2007 xx xx
 ...
 For example -fpsc=40 tells perltidy to put side comments in column 40 if possible.
 ...
 -Text following un-parenthesized if/unless statements get a full level of
 indentation.  Suggested by Jeff Armstorng and others. 
 OLD:
