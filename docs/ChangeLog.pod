=head1 Perltidy Change Log
 ...
 -Corrected a mistokenization of variables for a package with a name
  ...
  In this case, the leading 'my' was tokenized as a keyword, and a
 ...
 -A new document stylekey.pod has been created to guide new users
  through the maze of style parameters.  An html version is on the
  perltidy web page.  It should be very helpful.
 ...
 -A new flag -wocb=n has been added to allow existing list formatting
  to be retained.  (--want-old-comma-breaks).  See updated manual.
