=head1 Perltidy Change Log
 ...
 -Improved indentation of nested parenthesized expressions The new rule
 is that a paren following a keyword will get full indentation status
 unless the keyword starts a statement.  Tests have given favorable
 results.  (Thanks to Wolfgang Weisselberg for this suggestion).  
...
=head2 2001 07 23 
 ...
 block curly.  A workaround for older versions of perltidy is to use
 -nasc.
