...
=head2 2002 xx xx 
 ...
 -Added command --dump-profile (or -dpro) which will dump to standard output
  the name of whatever configuration file is in effect, and its contents.
 ...
 -Perltidy will now use system-generated temporary filenames when
  ...
  Also, a control-C handler has been added to delete temporary files if
