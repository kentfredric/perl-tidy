...
=head2 2001 xx xx  
 ...
 -A '-gnu' flag has been added which causes lists to be indented with
 extra indentation in the manner sometimes associated with emacs or the
 GNU suggestions.  It's not perfect yet but it is now quite useful and
 should improve over time.  Many thanks to Ian Stuart for this
 suggestion and for much help in testing it. The manual has been updated
 to discuss this.
