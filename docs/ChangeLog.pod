...
=head2 2001 06 25 
 ...
 curly braces which contain code BLOCKS. The default value is -bbt=1.

 -added flag -icp (--indent-closing-paren) which leaves a statment
 termination of the form C<);>, C<};>, or C<];> indented with the same
 ...
 -Vertical alignment updated to synchronize with tokens C<&&>, C<||>,
 C<and>, C<or>, C<if>, C<unless>.  Allowable space before forcing
