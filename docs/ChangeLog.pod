...
=head2 2002 xx xx
 ...
 -Sub prototypes no longer need to be on the same line as sub names.  This
 was required in perl 5 but not perl 6.
 ...
 deactivated with -npod.  Thanks to all who have written to discuss this,
