...
=head2 2001 xx xx
 ...
 -This version is about 20 percent faster as a result of optimization work.
 ...
 -Extensive testing with the '-extrude' option revealed these
 problems which were corrected:

     -'**=', which was incorrectly tokenized as '**' and '='.  This only
