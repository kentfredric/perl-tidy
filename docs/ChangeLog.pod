...
=head2 2002 xx xx
 ...
 -Improved alignment of opening braces.  Needed for improved switch/case
  formatting, and also suggested by Mark Olesen for sort/map/grep
 ...
 -Eliminated alignments across unrelated statements. Example:
  ...
  Thanks to Mark Olesen for noting this.

 -Numerous other minor improvements in vertical alignment.
...
=head2 2002 11 06
 ...
 is not great yet, but it parses ok.  The words 'switch', 'case', 'given', and
 'when' are now treated as keywords.  If this causes trouble with older code,
 we could introduce a switch to deactivate it.  Thanks to Stan Brown and Jochen
 Schneider for recommending this.
