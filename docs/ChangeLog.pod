...
=head2 2001 xx xx
 ...
 the tokenizer now outputs a unique serial number for every balanced pair
 of brace types and ?/: pairs.  This will simplify the formatter and 
 allow future formatting improvements.
 ...
 Also, deactivated the syntax check if perltidy is run as root.
