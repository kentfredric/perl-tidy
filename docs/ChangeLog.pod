...
=head2 2002 04 11
 ...
 -A new flag -iob (--ignore-old-breakpoints) has been added to
  ...
  format.  This is one of several new parameters which give some 
  control over the extent to which old line breaks influence the output
  format.
 ...
 -A new flag -boa (--break-at-old-arrow-breakpoints)
  has been added to control whether containers with comma-arrow tokens
  should be broken open.
