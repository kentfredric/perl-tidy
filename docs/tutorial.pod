...
the bottom.  You probably cannot control this, but you need to know
where to look when an actual error is detected.
...
That's enough to get started using perltidy.  Many additional special
